...
export default function HowItWorks() {
      ...
      mockup: (
        <div className="w-full max-w-[280px] bg-white border border-slate-100 rounded-3xl p-5 shadow-[0_4px_20px_rgba(15,23,42,0.015)] relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-4">
            <span className="text-[10px] uppercase font-bold text-slate-400">{t("how_step1_view")}</span>
          ...
          <div className="flex items-center justify-between text-xs">
            <span className="text-slate-600 font-medium">{t("how_step1_sugar")}:</span>
      ...
      mockup: (
        <div className="w-full max-w-[280px] bg-white border border-slate-100 rounded-3xl p-5 shadow-[0_4px_20px_rgba(15,23,42,0.015)] space-y-4">
          <div className="flex items-center justify-between">
            <span className="text-[10px] uppercase font-bold text-slate-400">{t("how_step2_view")}</span>
            <span className="text-xs text-slate-500">1:45 PM</span>
          </div>
          
          <div className="space-y-2 text-left">
            <div className="flex justify-between text-xs">
              <span className="text-slate-700 font-semibold">{t("how_step2_tea")}</span>
          ...
          <div className="flex gap-2.5 p-3 rounded-2xl bg-amber-50/70 border border-amber-100/50">
            ...
            <div className="space-y-0.5 text-left">
              <span className="text-[11px] font-semibold text-amber-800 block">{t("how_step2_warn")}</span>
              <span className="text-[10px] text-amber-700/80 leading-normal block">{t("how_step2_warn_desc")}</span>
            </div>
          </div>
        </div>
      ),
  ...
  return (
    <section id="how-it-works" className="py-16 md:py-28 bg-white relative overflow-hidden transition-colors duration-200">
